                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="single-blog-post mb-50 wow fadeInUp" data-wow-delay="300ms">
                                    ...
                                    <!-- Post Title -->
                                    <a href="<?php echo base_url() ?>assets/front/#" class="post-title"><?php echo $berita->judul ?></a>
                                    <!-- Post Meta -->
                                    <div class="post-meta">
                                        <p>By <a href="<?php echo base_url() ?>"><?php echo $berita->pengguna ?></a> | <a href="<?php echo base_url() ?>"><?php echo $berita->tanggal_input ?></a> | <a href="<?php echo base_url() ?>"></a></p>
                                    </div>
                                    <!-- Post Excerpt -->
