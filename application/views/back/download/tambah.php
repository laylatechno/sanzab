        ...
        <div class="col-lg-12 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    ...
                    echo form_open_multipart(base_url('back/download/tambah'),' class="form-horizontal"');
                    ?>    
                        <form class="form-horizontal">
                            <div class="form-group">
                              <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama" minlength="3" placeholder="Masukkan Nama Download" value="<?php echo set_value('nama') ?>" required>
                              </div>
                            </div>
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              <div class="col-sm-10">
                                <input type="text" class="form-control" name="link" minlength="4" placeholder="Masukkan Link Download" value="<?php echo set_value('link') ?>" required>
                              </div>
                            </div>
