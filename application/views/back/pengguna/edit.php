                ...
                <div class="col-12 mt-5">
                    <div class="card">
                     ...
                     <?php 
                        ...
                        echo form_open_multipart(base_url('back/pengguna/edit/'.$pengguna->id_pengguna),' class="form-horizontal"');
                        ?>
                        <form class="form-horizontal">
                            ...
                            <div class="form-group "> 
                             ...
                             <div class="form-group">
                                ...
                                &nbsp; &nbsp;&nbsp;
                                <a href="<?php echo base_url('back/pengguna') ?>" class="btn btn-danger" name="reset"><i class="fa fa-retweet"></i> Kembali</a>
                             </div>
                              <!-- /.box-footer -->
                        </form>
                        <?php echo form_close(); ?>      
