        ...
        <div class="col-lg-12 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    ...
                    echo form_open_multipart(base_url('back/price/tambah'),' class="form-horizontal"');
                    ?>    
                        <form class="form-horizontal">
                            <div class="form-group">
                             ...
                             <div class="form-group"> 
                              <div class="col-sm-10">
                                <input type="number" class="form-control" name="harga" minlength="1" placeholder="Masukkan Harga" value="<?php echo set_value('harga') ?>" required>
                              </div>
                            </div>
