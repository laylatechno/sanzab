        ...
        <div class="col-lg-12 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    ...
                    echo form_open_multipart(base_url('back/kegiatan/tambah'),' class="form-horizontal"');
                    ?>    
                        <form class="form-horizontal">
                            ...
                            <div class="form-group"> 
                              <div class="col-sm-10">
                                <input type="text" class="form-control" name="icon" minlength="4" placeholder="Masukkan Icon" value="<?php echo set_value('icon') ?>" >
                              </div>
                            </div>
